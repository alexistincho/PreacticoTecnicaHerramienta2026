...
/*=========================VERIFICAR QUE LA NOTICIA SEA DEL USUARIO Y ESTÉ EN PARA CORRECCIÓN=========================*/
...
if (!$noticia || $noticia["estado"] != "Para Corrección") {
...
$sql_historial = "INSERT INTO historial (id_noticia, id_usuario, estado_anterior, estado_nuevo) 
                  VALUES (?, ?, 'Para Corrección', 'Lista para Validación')";
